...
long pulseTime = 250;   //Pulse time interval (ms)
...
byte speedLimit = 32;   //used to store speed limit allowable for locker use (32 = 40MPH, 40 = 50MPH)
byte speedEnable = 5;   //used to store maximum enable speed for lockers (5 = 6 MPH)
...
void interiorLED()    //Used to control interior red LEDs
{
  ...
  {
    if(dimmerData1 == 34) brightness = 15;    //set dimmer to 1st notch value
    else if(dimmerData1 == 76) brightness = 20;   //set dimmer to 2nd notch value
    else if(dimmerData1 == 118) brightness = 25;  //set dimmer to 3rd notch value
    else if(dimmerData1 == 160) brightness = 30;  //set dimmer to 4th notch value
    else if(dimmerData1 == 200) brightness = 35;  //set dimmer to 5th notch value
  }
